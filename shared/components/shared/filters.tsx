...
import { useQueryFilters, useIngredients, useFilters } from '@/shared/hooks/indext';
    ...
    return (
        <div className={className}>
            ...
            <div className='"mt-5 border-y border-y-neutral-100 py-6 pb-7"'>
                ...
                <RangeSlider min={0} max={1000} step={10} value={[filters.prices.priceFrom || 0, filters.prices.priceTo || 1000]} onValueChange={updatePrice} />
            </div>
            <CheckboxFiltersGroup title="Ингредиенты:" className='mt-5' limit={6} defaultItems={items.slice(0, 6)} items={items} loading={loading} onClickCheckbox={filters.setSelectedIngredients} selectedIds={filters.selectedIngredients} name='ingredients' />
        </div>
    );
};